  <footer>
      <div class="footer-container">
          <div class="footer-section">
              ...
              <p id="ftDesc">NEX Real Estate এর একটি প্রকল্প। আপনার স্বপ্নের বাড়ি নির্মাণের জন্য প্রিমিয়াম লোকেশনে
                  সবুজ পরিবেশে গড়ে উঠেছে জলজোছনা।</p>
          ...
          <div class="footer-section" style="margin-left: 110px">
              ...
              <p id="ftContactAddress">NEX Real Estate, Century Trade Center, House-23/C, Road-17, Kamal Ataturk Ave,
                  Banani C/A, Dhaka</p>
          ...
          <div class="footer-section" style="margin-left:110px">
              ...
              <ul class="footer-links">
                  <li><a id="ftQlHome" href="#home"><i class="fas fa-chevron-right"></i> <span
                              id="ftQlHomeText">হোম</span></a></li>
                  <li><a id="ftQlFeatures" href="#features"><i class="fas fa-chevron-right"></i> <span
                              id="ftQlFeaturesText">সুবিধাসমূহ</span></a></li>
                  <li><a id="ftQlPricing" href="#pricing"><i class="fas fa-chevron-right"></i> <span
                              id="ftQlPricingText">মূল্য তালিকা</span></a></li>
                  <li><a id="ftQlContact" href="#contact"><i class="fas fa-chevron-right"></i> <span
                              id="ftQlContactText">যোগাযোগ</span></a></li>
                  <li><a id="ftQlGallery" href="#"><i class="fas fa-chevron-right"></i> <span
                              id="ftQlGalleryText">গ্যালারি</span></a></li>
              </ul>

              <h3>আইনি তথ্য</h3>
              <ul class="footer-links">
                  <li><a id="ftPrivacy" href="#"><i class="fas fa-chevron-right"></i> <span
                              id="ftPrivacyText">গোপনীয়তা নীতি</span></a></li>
                  <li><a id="ftTerms" href="#"><i class="fas fa-chevron-right"></i> <span id="ftTermsText">সেবার
                              শর্তাবলী</span></a></li>
              </ul>
          </div>
          <div class="footer-section qr-section">
              ...
              <div class="qr-container">
                  ...
                  <img alt="QR Code" src="/images/alphainno-qr-code.png" />

                  <div id="qr-reader-results"></div>
                  <a id="ftMap" href="https://maps.google.com/?q=শুভনূর+৩৮৮+বাড়ি+সিদ্ধার্থ+এস+আবাস,+খুলনা"
  ...
  <script>
      (function() {
          ...
          const setHref = (id, val) => {
              const el = document.getElementById(id);
              if (el && typeof val === 'string') el.setAttribute('href', val);
          };
          ...
          function applyFooterSettings(saved) {
              ...
              // quick links
              setText('ftQlHomeText', saved.qlHomeLabel);
              setHref('ftQlHome', saved.qlHomeHref);
              setText('ftQlFeaturesText', saved.qlFeaturesLabel);
              setHref('ftQlFeatures', saved.qlFeaturesHref);
              setText('ftQlPricingText', saved.qlPricingLabel);
              setHref('ftQlPricing', saved.qlPricingHref);
              setText('ftQlContactText', saved.qlContactLabel);
              setHref('ftQlContact', saved.qlContactHref);
              setText('ftQlGalleryText', saved.qlGalleryLabel);
              setHref('ftQlGallery', saved.qlGalleryHref);

              // legal
              setText('ftPrivacyText', saved.legalPrivacyLabel);
              setHref('ftPrivacy', saved.legalPrivacyHref);
              setText('ftTermsText', saved.legalTermsLabel);
              setHref('ftTerms', saved.legalTermsHref);
